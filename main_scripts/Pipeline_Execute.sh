...
#	HTSeq_ref=${ref_dir}/Equus_caballus_Aug2024/GCF_041296265.1_TB-T2T_genomic.gtf; 
	...
	species_ref="Equus caballus 3.0";
	Bowtie2_ref=${ref_dir}/Archive-Retired_Refs/Equus_caballus/Bowtie2/horse; 
	STAR_ref=${ref_dir}/Archive-Retired_Refs/Equus_caballus/STAR;
	HTSeq_ref=${ref_dir}/Archive-Retired_Refs/Equus_caballus/Equus_caballus.EquCab3.0.98.gtf; 
else 
	species_ref="GRCr8";
